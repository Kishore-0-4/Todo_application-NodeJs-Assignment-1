...
app.get("/todos/", async (request, response) => {
  ...
  switch (true) {
    ...
    case hasStatusPriority(request.query):
      ...
      break;
    //SCENARIO 2:- If Has ONLY PRIORITY
